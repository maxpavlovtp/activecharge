...
//	todo move to stationService
	...
	@GetMapping("/v2/station/isOnline")
	public ResponseEntity<Boolean> isOnline(
			@Parameter(description = "Station number")
			@NotBlank @RequestParam("station_number")
			String stationNumber) {

		return ResponseEntity.status(HttpStatus.OK).body(stationService.isOnline(stationNumber));
	}
}
