      ...
      <div className={styles.contractsBox}>
        <div className={styles.textContainer}>
          ...
          <p>
            ...
            відносяться до Фізічної Особи Підпріємця (далі - "ФОП") "Павлов
            Максим Валерійович"
          </p>
          <p>
          ...
          <p>
            ...
            про її прийняття. Вчинення особою, яка одержала оферту, у термін,
            встановлений для її акцепту, дій по виконанню зазначених у ній умов
            договору (оплата послуг та ін.) вважається акцептом.
          </p>
          <p>
            <strong>Акцепт оферти</strong>- повне і беззастережне прийняття умов
            Договору-оферти, шляхом здійснення дій Клієнтом, що виражає намір
            скористатися Веб-сайтом для оформлення Послуг.
          </p>
          <p>
          ...
          <p>
            ...
            технічних можливостей інтернет-сайту 220-km.com, (далі - "Договір"),
            укладається між ФОП "Павлов Максим Валерійович" і Клієнтом.
          </p>
          <p>
          ...
          <p>
            2.1. ФОП "Павлов Максим Валерійович" зобов'язується надати Клієнту
          ...
          <p>
            ...
            оферти) з моменту підтвердження Клієнтом своєї згоди з його умовами,
            шляхом установки відповідної позначки на інтернет-сайті 220-km.com,
            після чого публічний Договір вважається базовим документом в
            офіційних взаєминах між ФОП "Павлов Максим Валерійович" і Клієнтом.
          </p>
          <p>
            ...
            споживачів, беззастережне прийняття яких (оплата будь-яким способом
            відповідно до ч.2 ст. 642 Цивільного кодексу України) вважається
            акцептом даного Договору між Клієнтом та виконавцем та засвідчує
            факт його укладення.
          </p>
          <p>
            2.4 Послуги Веб-сайту надаються тільки після підтвердження згоди
            Клієнта з умовами Договору. Наша компанія має право без попередження
            вносити зміни в Договір. Отже, просимо Вас кожного разу, перед
            оплатою, переглядати поточну версію Договору.
          </p>
          <p id="siteUsage">
            <strong>
          ...
          <p>
            - Цим іншим особам Ви повідомите про правила і умови, які стосуються
            зарядки, зроблених Вами від їх імені, включаючи всі застосовувані
            правила і обмеження;
          </p>
          <p>
          ...
          <p>4.1 Вся інформація на нашому Веб-сайті належать нам.</p>
          <p>
            4.2 До тих пір поки Клієнту надається можливість використання нашого
            Веб-сайту, він дає свою згоду не зраджувати, не копіювати, не
            поширювати, не передавати іншим особам, не відтворювати, не
          ...
          <p>- здійснювати спекулятивні, неправдиві або шахрайські зарядки;</p>
          <p>
            - отримувати доступ, моніторити або копіювати будь-який контент або
            інформацію з даного Веб-сайту, використовуючи будь-яких роботів,
            пошукових агентів або інші автоматичні засоби або будь-які ручні
            процеси з будь-якою метою без нашого виданого письмового дозволу;
          </p>
          <p>
            - порушувати обмеження будь-якого HTTP-заголовка для блокування
            роботи на цьому Веб-сайті і здійснювати будь-які інші шахрайські дії
            щодо інших засобів, які застосовуються, щоб запобігти або обмежити
            доступ до цього Веб-сайту;
          </p>
          <p>
          ...
          <p>
            5.1 Користувач повинен ознайомитися з даним Договором і підтвердити
            свою згоду з його умовами при замовленні будь-якої Послуги на Сайті.
          </p>
          <p>
          ...
          <p id="costs">
            <strong>
              <u>
                6. Вартість послуг і порядок розрахунку при зарядці
                електромобіля
              </u>
            </strong>
          </p>
          <p>
            6.1 Для початку зарядки потрібно натіснути кнопку "Старт" та зробити
            оплату.
          </p>
          <p>
            6.2 Після натискання кнопки “Старт”, Клієнт переходить безпосередньо
            до процедури оплати. На сторінці Оплати заповнює номер банківської
            картки, термін придатності та трьохзначний код, що знаходиться на
            зворотній стороні картки. Деякі банки можуть відправити смс пароль
            на телефон, вказаний при оформленні банківської карти. В такому
            випадку, для успішної оплати, Клієнт має ввести смс пароль і
            натиснути кнопку “Підтвердити”. Після цього Клієнт побачить
            повідомлення “Оплата виконана успішно”, після чого відразу потрапляє
            на сторінку з прогресом його зарядки. На цій сторінці Клієнт може
          ...
          <p>7.2 Веб-сайт має право брати комісію за повернення коштів.</p>
          <p id="gatheringInfo">
            <strong>
          ...
          <p>
            8.3 На залишені Клієнтом контактні дані у вигляді адреса електронної
            пошти чи номера телефона, Ми залишаємо за собою право відправляти
            рекламні матеріали у вигляді поштових/смс розсилок.
          </p>
          <p>
          ...
          <p>
            ...
            необхідна згода її батьків, на отримання її персональної інформації.
          </p>
          <p id="software">
            <strong>
          ...
          <p>
            ...
            перегляду даного Веб-сайту відповідно до цих норм і умов, але не для
            яких би то не було інших цілей.
          </p>
          <p>
            ...
            HTML(АШТІЕМЕЛ) i JavaScript(ДЖАВАСКРИПТ) код є власністю і
            знаходиться під захистом законів про авторське право і умов
            міжнародних договорів. Будь-яке розмноження або розповсюдження
            Програмного Забезпечення категорично заборонено і може призвести до
            суворого цивільного і кримінального покарання. Порушники будуть
          ...
          <p>
            якого вже відвідував наш сайт. В даному випадку мова йде про те, що
            ми можемо використовувати куки для того, щоб запам'ятати
            реєстраційну інформацію Клієнта;
          </p>
          <p>- прописати Ваш пароль;</p>
          <p>
            - допомогти оцінити і проаналізувати дієвість функцій та пропозицій
            Веб-сайту, реклами і електронних повідомлень (спостерігаючи за тим,
            які Клієнт найчастіше відкриває);
          </p>
          <p>- рекламних цілях.</p>
          <p>
            У більшості браузерів Клієнту надається можливість відключення всіх
            Куків.
          </p>
          <p id="contacts">
            <strong>
          ...
          <p>
            Якщо у Клієнта виникли питання про заплановані подорожі або покупку,
            будь ласка, напишіть нам електронне повідомлення на адресу
            km220.com@gmail.com, або зв'яжіться за номером +38 (097) 198-37-59.
          </p>
          <p>
            <strong> </strong>
          </p>
